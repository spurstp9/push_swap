...
PUSH_SWAP_SRC_FILES = apply_instr.c check_order.c chunk_sort.c deal_with_three.c deal_with_five.c ft_p.c ft_r.c ft_rr.c ft_s.c main_push_swap.c parsing.c selection_sort.c utils.c
